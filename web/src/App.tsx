...
function App() {
  const [tab, setTab] = useState<'inbox' | 'setup' | 'clients' | 'collaboration'>('inbox');
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <nav className="flex space-x-4">
              ...
              <button 
                ...
                className={`px-3 py-2 rounded-md text-sm font-medium ${tab === 'collaboration' ? 'bg-gray-100 text-gray-900' : 'text-gray-500 hover:text-gray-900'}`}
              >
                👥 Collaboration
              </button>
              <button 
